...
-- added
select define_function_args('push_task_ahead','task_id,state,user_id,workflow_key,transition_key');

--
-- procedure push_task_ahead/5
--
CREATE OR REPLACE FUNCTION push_task_ahead(
   push_task_ahead__task_id integer,
   push_task_ahead__state varchar,
   push_task_ahead__user_id integer,
   push_task_ahead__workflow_key varchar,
   push_task_ahead__transition_key varchar
) RETURNS integer AS $$
DECLARE
